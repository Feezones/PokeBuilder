...
const translations = {
  en: {
    ...
    // Login
    'login.subtitle': 'Sign in to access your teams',
    'login.emailPlaceholder': 'Email',
    'login.passwordPlaceholder': 'Password',
    'login.namePlaceholder': 'Trainer name (optional)',
    'login.login': 'Log in',
    ...
    'login.errEmailInUse': 'This email is already registered.',
    'login.errInvalidEmail': 'Invalid email address.',
    'login.errUserNotFound': 'Account not found.',
    'login.errWrongPassword': 'Incorrect password.',
    'login.errInvalidCredential': 'Invalid email or password.',
    ...
    'battle.subtitle': 'Choose PVP or PVE to start a Doubles battle!',
    'battle.pve': 'PVE — vs AI',
    'battle.pveDesc': 'Battle against a competitive AI-generated team.',
    'battle.pvp': 'PVP — vs Trainer',
    'battle.pvpDesc': 'Search for a trainer and challenge their team!',
    'battle.difficulty': 'Difficulty',
    'battle.easy': 'Easy',
    'battle.normal': 'Normal',
    'battle.hard': 'Hard',
    'battle.startPVE': 'Start PVE Battle',
    'battle.searchTrainer': 'Search trainer name...',
    'battle.search': 'Search',
    'battle.challenge': 'Challenge',
    'battle.teams': 'teams',
    'battle.noTrainerFound': 'No trainer found with that name.',
    'battle.searchError': 'Error searching for trainers.',
    'battle.generating': 'Generating opponent team...',
    'battle.loading': 'Loading opponent...',
    'battle.noTeamFound': 'This trainer has no valid team.',
    'battle.back': 'Back',
    'battle.teamPreview': 'Team Preview',
    'battle.yourTeam': 'Your Team',
    'battle.select4': 'Select 2-4 Pokémon',
    'battle.selected': 'Selected',
    'battle.startBattle': 'Start Battle!',
    'battle.needTeam': 'You need at least 2 Pokémon in your team to battle!',
    'battle.preparing': 'Preparing battle...',
    'battle.initError': 'Failed to initialize the battle.',
    'battle.forfeit': 'Forfeit',
    'battle.confirmForfeit': 'Are you sure you want to forfeit this battle?',
    'battle.turn': 'Turn',
    'battle.chooseMoves': 'Choose your moves',
    'battle.selectTarget': 'Select target:',
    'battle.executeTurn': 'Execute Turn',
    'battle.chooseReplacement': 'Choose a replacement Pokémon',
    'battle.log': 'Battle Log',
    'battle.victory': 'Victory!',
    'battle.defeat': 'Defeat!',
    'battle.victoryMsg': 'You won the battle! Congratulations, trainer!',
    'battle.defeatMsg': 'You lost the battle. Try again with a different strategy!',
    'battle.backToMenu': 'Back to Battle Menu',
    'battle.you': 'You',
  ...
  'pt-br': {
    ...
    // Login
    'login.subtitle': 'Entre para acessar seus times',
    'login.emailPlaceholder': 'Email',
    'login.passwordPlaceholder': 'Senha',
    'login.namePlaceholder': 'Nome do treinador (opcional)',
    'login.login': 'Entrar',
    ...
    'login.errEmailInUse': 'Este email já está cadastrado.',
    'login.errInvalidEmail': 'Email inválido.',
    'login.errUserNotFound': 'Conta não encontrada.',
    'login.errWrongPassword': 'Senha incorreta.',
    'login.errInvalidCredential': 'Email ou senha inválidos.',
    'login.errTooMany': 'Muitas tentativas. Tente novamente mais tarde.',
    'login.errGeneric': 'Ocorreu um erro. Tente novamente.',
    ...
    'battle.subtitle': 'Escolha PVP ou PVE para iniciar uma batalha Doubles!',
    'battle.pve': 'PVE — vs IA',
    'battle.pveDesc': 'Batalhe contra um time competitivo gerado por IA.',
    'battle.pvp': 'PVP — vs Treinador',
    'battle.pvpDesc': 'Busque um treinador e desafie seu time!',
    'battle.difficulty': 'Dificuldade',
    'battle.easy': 'Fácil',
    'battle.normal': 'Normal',
    'battle.hard': 'Difícil',
    'battle.startPVE': 'Iniciar Batalha PVE',
    'battle.searchTrainer': 'Buscar nome do treinador...',
    'battle.search': 'Buscar',
    'battle.challenge': 'Desafiar',
    'battle.teams': 'times',
    'battle.noTrainerFound': 'Nenhum treinador encontrado com esse nome.',
    'battle.searchError': 'Erro ao buscar treinadores.',
    'battle.generating': 'Gerando time adversário...',
    'battle.loading': 'Carregando adversário...',
    'battle.noTeamFound': 'Este treinador não tem um time válido.',
    'battle.back': 'Voltar',
    'battle.teamPreview': 'Prévia dos Times',
    'battle.yourTeam': 'Seu Time',
    'battle.select4': 'Selecione 2-4 Pokémon',
    'battle.selected': 'Selecionados',
    'battle.startBattle': 'Iniciar Batalha!',
    'battle.needTeam': 'Você precisa de pelo menos 2 Pokémon no seu time para batalhar!',
    'battle.preparing': 'Preparando batalha...',
    'battle.initError': 'Falha ao iniciar a batalha.',
    'battle.forfeit': 'Desistir',
    'battle.confirmForfeit': 'Tem certeza que deseja desistir desta batalha?',
    'battle.turn': 'Turno',
    'battle.chooseMoves': 'Escolha seus golpes',
    'battle.selectTarget': 'Selecione o alvo:',
    'battle.executeTurn': 'Executar Turno',
    'battle.chooseReplacement': 'Escolha um Pokémon substituto',
    'battle.log': 'Log de Batalha',
    'battle.victory': 'Vitória!',
    'battle.defeat': 'Derrota!',
    'battle.victoryMsg': 'Você venceu a batalha! Parabéns, treinador!',
    'battle.defeatMsg': 'Você perdeu a batalha. Tente novamente com outra estratégia!',
    'battle.backToMenu': 'Voltar ao Menu de Batalha',
    'battle.you': 'Você',
